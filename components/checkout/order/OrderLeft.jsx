...
//   const { userDetails, paymentData } = useSelector((store) => store.user);
      ...
      <div className="OrderLeftWrapper">
        ...
        <div className="OrderLeftWrapperTop top1">
          ...
          <ul className="OrderLeftList">
            <li>
              {" "}
              <span>Name</span>: {addressData?.firstname}{" "}
            ...
            <li>
              {" "}
              <span>Address</span>: {addressData?.address} {addressData?.city},{" "}
              {addressData?.country}
            </li>
          </ul>
          ...
          {!order?.isDelivered ? (
            ...
            <Message
              alertText={`Delivered on ${deliveredDate}`}
              alertType="success"
            />
          )}
        </div>
        ...
        <div className="OrderLeftWrapperCenter">
          ...
          {order?.orderItems?.map((x) => {
            return (
              <div className="OrderLeftCenter" key={x._id}>
